...
namespace Backend.Data.Migrations
{
    ...
    [Migration("20230726101339_AddManyToManyBetweenCourseAndUser")]
    partial class AddManyToManyBetweenCourseAndUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Modules.CourseBlocks.Contracts.CourseBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Modules.CourseContents.File.Contracts.FileContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Modules.CourseContents.Text.Contract.TextContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Modules.CourseContents.File.Contracts.FileContent", b =>
                {
                    b.HasOne("Backend.Modules.CourseBlocks.Contracts.CourseBlock", "Block")
                        .WithMany()
                        .HasForeignKey("BlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Modules.Courses.Contract.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Modules.Static.Contracts.StaticFile", "File")
                        .WithMany()
                        .HasForeignKey("FileId");

                    b.HasOne("Backend.Modules.Static.Contracts.StaticFile", "Icon")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Modules.CourseContents.Text.Contract.TextContent", b =>
                {
                    ...
                    b.HasOne("Backend.Modules.Static.Contracts.StaticFile", "Content")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Modules.Users.Contract.User", b =>
                {
                    b.HasOne("Backend.Modules.Static.Contracts.StaticFile", "Avatar")
                        .WithMany()
            ...
            modelBuilder.Entity("CourseUser", b =>
                {
                    ...
                    b.HasOne("Backend.Modules.Users.Contract.User", null)
                        .WithMany()
