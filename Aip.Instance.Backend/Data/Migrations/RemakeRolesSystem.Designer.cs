...
namespace Aip.Instance.Backend.Data.Migrations
{
    ...
    [Migration("20240218105354_RemakeRolesSystem")]
    partial class RemakeRolesSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aip.Instance.Backend.Data.Models.Internship", b =>
                {
                    ...
                    b.Property<Guid>("PrimaryTutorId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("PrimaryTutorId");
            ...
            modelBuilder.Entity("Aip.Instance.Backend.Data.Models.Internship", b =>
                {
                    b.HasOne("Aip.Instance.Backend.Data.Models.User", "PrimaryTutor")
                        .WithMany()
                        .HasForeignKey("PrimaryTutorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PrimaryTutor");
                });
