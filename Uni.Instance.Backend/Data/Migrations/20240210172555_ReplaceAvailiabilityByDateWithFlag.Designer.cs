...
namespace Uni.Instance.Backend.Data.Migrations
{
    ...
    [Migration("20240210172555_ReplaceAvailiabilityByDateWithFlag")]
    partial class ReplaceAvailiabilityByDateWithFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uni.Instance.Backend.Data.Models.CourseContentFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Uni.Instance.Backend.Data.Models.StaticFile", b =>
                {
            ...
            modelBuilder.Entity("Uni.Instance.Backend.Data.Models.CourseContentFile", b =>
                {
                    b.HasOne("Uni.Instance.Backend.Data.Models.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Uni.Instance.Backend.Data.Models.StaticFile", "File")
                        .WithMany()
                        .HasForeignKey("FileId");

                    b.HasOne("Uni.Instance.Backend.Data.Models.CourseSection", "Section")
                        .WithMany()
